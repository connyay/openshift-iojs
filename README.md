...
---
1. **io.js** ([latest stable](http://semver.io/iojs/stable) currently 2.0.2)
...
Note
---
For now I just dropped the contents of the iojs-v2.0.2.tar.xz [here](bin/iojs). Once io.js stabalizes I will move to resolving the latest stable and downloading on the gear.
