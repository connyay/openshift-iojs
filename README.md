...
---
1. **io.js** ([latest stable](http://semver.io/iojs/stable) currently 2.2.1)
2. **npm** (latest stable currently 2.11.0)
3. **grunt**
4. **bower**
...
Note
---
For now I just dropped the contents of the iojs-v2.2.1.tar.xz [here](bin/iojs). Once io.js stabalizes I will move to resolving the latest stable and downloading on the gear.
