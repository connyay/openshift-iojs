...
---
1. **io.js** ([latest stable](http://semver.io/iojs/stable) currently 3.0.0)
...
Note
---
For now I just dropped the contents of the iojs-v3.0.0.tar.xz [here](bin/iojs). Once io.js stabalizes I will move to resolving the latest stable and downloading on the gear.
